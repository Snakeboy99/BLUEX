...
local BlueX_Library = Instance.new("ScreenGui")
BlueX_Library.Name = "BlueX_Library"
BlueX_Library.Enabled = true
...
function library.new(name, settings)
    ...
    Main_F.BorderSizePixel = 0;
    Main_F.Position = UDim2.new(0, 9, 0, 53);
    Main_F.Size = UDim2.new(0, 218, 0, 358);
    Main_F.ZIndex = 2;
    Main_F.Visible = true;
    Main_F.Parent = BlueX_Library;

    local UICorner_M = Instance.new("UICorner")
    UICorner_M.Name = "UICorner";
    UICorner_M.CornerRadius = UDim.new(0, 6);
    UICorner_M.Parent = Main_F;
    ...
    Title.Size = UDim2.new(0, 218, 0, 28);
    Title.ZIndex = 4;
    Title.Font = Enum.Font.SourceSansSemibold;
    Title.Text = UILibraryNAME;
    Title.TextColor3 = Color3.fromRGB(208, 208, 208);
    Title.TextSize = 24.000;
    Title.TextStrokeColor3 = Color3.fromRGB(109, 109, 109);
    Title.TextXAlignment = Enum.TextXAlignment.Left;
    Title.Visible = true;
    Title.Parent = Main_F;

    local UIPadding_Title = Instance.new("UIPadding")
    UIPadding_Title.PaddingLeft = UDim.new(0, 6);
    UIPadding_Title.Parent = Title;

    local Theme = Instance.new("ImageButton")
    Theme.Name = "Theme"
    Theme.Parent = Main_F
    Theme.BackgroundColor3 = Color3.fromRGB(79, 132, 255)
    Theme.BackgroundTransparency = 1.000
    Theme.Position = UDim2.new(0.908256888, -48, 0.00238095224, 4)
    Theme.Size = UDim2.new(0, 18, 0, 18)
    Theme.ZIndex = 5
    ...
    Theme.TileSize = UDim2.new(0, 5, 0, 5)
